...
var COMPONENT_IDENTIFICATOR_ID = "component_opener"
var COMPONENT_REAL_ID = "componentrealid_opener"

var ComponentIdentificatorID = ""
var ComponentPublicKey = ""
var ComponentPrivateKey = ""

var OpenerIdentificator = &cryptoutils.Identificator{}
...
func LoadComponent() error {
	...
	if err != nil || privateKeyPem == "" {
		...
		OpenerIdentificator = &cryptoutils.Identificator{}
		OpenerIdentificator.IdentificatorID = uuid
		OpenerIdentificator.IdentificatorType = cryptoutils.IDENTIFICATOR_TYPE_OPENER

		err = cryptoStorage.AddIdentificator(OpenerIdentificator)
	...
	OpenerIdentificator = &cryptoutils.Identificator{}
	OpenerIdentificator.IdentificatorID = ComponentIdentificatorID
	OpenerIdentificator.IdentificatorType = cryptoutils.IDENTIFICATOR_TYPE_OPENER
